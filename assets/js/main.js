...
/*=============== VALUE ACCORDION ===============*/
// const accordionHeaders = document.querySelectorAll('.value__accordion-header')

// accordionHeaders.forEach(accordionHeader => {
//     accordionHeader.addEventListener("click", event => {
//         const currentlyActiveAccordionHeader = document.querySelector('.value__accordion-header.active')
...
//             currentlyActiveAccordionHeader.nextElementSibling.getElementsByClassName.maxHeight = 0
//         }
...
function scrollUp(){
    ...
    //when the scoll is higher than 350 viewport height, add the show-scroll class to the a tag with the scroll
